  ...
  return (
    ...
    >
      ...
      <nav>
        ...
        <a
          href="https://github.com/Developer27149/typescript_as_life"
          target="_blank"
        >
          <BsGithub className="w-6 h-6" />
        </a>
        <div onClick={onToggleIsDarkTheme} className={styles.theme_switch}>
          <span
            className={cn(
              { "opacity-0": isHiddenMoon },
              "bg-gray-700 p-1 rounded-full"
            )}
          >
            <BsMoon />
          </span>
